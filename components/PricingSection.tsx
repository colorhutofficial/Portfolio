...
const PricingCard: React.FC<PricingCardProps> = ({ name, price, originalPrice, discount, features, whatsappLink, delay, isPopular }) => (
    <motion.div 
      ...
      className={`relative bg-white rounded-3xl p-8 flex flex-col items-center transition-all duration-500 group ${
        isPopular 
    ...
    >
        ...
        <a 
          href={whatsappLink}
          className={`mt-auto w-full py-4 rounded-xl font-bengali font-bold text-center transition-all duration-300 relative overflow-hidden group/btn ${
              isPopular 
